        ...
        ListHeaderComponent={
          <View style={styles.headerContent}>
            <View style={styles.grid}>
              ...
              <StatCard
                label="Customers"
                value={String(summary?.activeCustomersCount ?? 0)}
            ...
            <Pressable
              onPress={() => navigateApp("Inventory")}
              accessibilityRole="button"
              accessibilityLabel="View low stock products"
            >
              <Card style={styles.lowStock}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.lowText}>
                    {summary?.lowStockProductsCount ?? 0} products need
          ...
          <Card style={styles.sale}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.saleMeta}>
                {item.saleNumber} | {item.itemCount} items
              </Text>
            </View>
